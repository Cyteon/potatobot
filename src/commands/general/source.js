        ...
        embeds: [
            {
                ...
                fields: [
                    ...
                    {
                        name: "📜 GNU GPL v3",
                        value: "https://www.gnu.org/licenses/gpl-3.0.html",
                    },
                    {
                        name: "📜 Extra Terms",
                        value: `\`\`\`
In addition to the terms of the GNU General Public License, the
following restriction applies:

1. The "source" command or functionality must always be included in
   the source code. This command or functionality must not be removed,
   altered, or disabled in any way. The "source" command is defined
   as the function or method that provides access to the original
   source code or other relevant project information.
                        \`\`\``
                    }
                ]
            }
