...
const execute = async function (interaction) {
    ...
    if (Date.now() - lastDaily < 86400000) {
        return await interaction.reply(`🕒 You have already claimed your daily reward! Try again <t:${(Date.now() / 1000 + 86400).toFixed(0)}:R>`);
    }
    ...
    await interaction.reply(`💵 You have claimed your daily reward and got $${rand}!`);
}
